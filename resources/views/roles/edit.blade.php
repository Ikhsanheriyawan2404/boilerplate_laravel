...
<div class="content-header">
    ...
    <div class="row mb-2">
        <h1 class="m-0">{{ __('Edit Role : ' . $role->name) }}</h1>
    </div><!-- /.row -->
    </div><!-- /.container-fluid -->
</div>
<!-- /.content-header -->
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control form-control-sm @error('name') is-invalid @enderror" placeholder="Masukan nama role" value="{{ old('name') ??  $role->name }}">
                            @error('name')
